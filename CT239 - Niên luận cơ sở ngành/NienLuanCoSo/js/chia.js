...
function checkAnswer() {
    ...
    var number1 = parseFloat(document.getElementById('random-number-1').innerText);
    var number2 = parseFloat(document.getElementById('random-number-2').innerText);
    var expectedSum = number1 / number2;
    expectedSum = expectedSum.toFixed(1);
